...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'addedToMistakeBook': 'Added to Mistake Book',
      'removeFromMistakeBook': 'Remove from Mistake Book',
      'removedFromMistakeBook': 'Removed from Mistake Book',
      'note': 'Note',
      'tags': 'Tags',
      'addNote': 'Add Note',
      'saveNote': 'Save Note',
      ...
      'reviewSubtitle': 'Review with Ebbinghaus',
      'reviewCompleted': 'Review Completed!',
      'comeBackTomorrow': 'Great job, come back tomorrow',
      'forgot': 'Forgot',
      'remembered': 'Remembered',
      'tapToFlip': 'Tap card to see answer',
    },
    'zh': {
      'appTitle': '答达——你的AI家教',
      'settings': '设置',
      ...
      'addedToMistakeBook': '已加入错题本',
      'removeFromMistakeBook': '移出错题本',
      'removedFromMistakeBook': '已移出错题本',
      'note': '笔记',
      'tags': '标签',
      'addNote': '添加笔记',
      'saveNote': '保存笔记',
      ...
      'viewSelfStudy': '系统自学',
      'dailyReview': '每日复习',
      'reviewSubtitle': '艾宾浩斯遗忘曲线温习错题',
      'reviewCompleted': '今日复习已完成！',
      'comeBackTomorrow': '太棒了，明天继续保持哦',
      'forgot': '忘记了',
      'remembered': '记住了',
      'tapToFlip': '点击卡片查看答案',
    },
